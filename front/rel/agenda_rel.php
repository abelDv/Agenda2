<?php
    require "../../back/list/listAgendamentos.php";
?>
    ...
    <div class="form-group">
        <table class="table table-bordered">
            ...
            <thead>
                ...
                <tr>
                    <tH scope="row"><?php echo $dadoAgend['id']; ?></th>
                    <td><?php echo $dadoAgend['NMedico']; ?></td>
                    <td><?php echo $dadoAgend['NCliente']; ?></td>
                    <td><?php echo $dadoAgend['DATA']; ?></td>
                    <td><?php echo $dadoAgend['HORARIO']; ?></td>
                </tr>
                <?php } ?>
            </table>
        </div>
